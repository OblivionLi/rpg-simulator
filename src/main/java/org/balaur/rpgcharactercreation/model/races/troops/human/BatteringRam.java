...
public class BatteringRam extends BaseTroop {
    private final int COMBAT_STARTING_VALUE = 60;
    private final int HEALTH_STARTING_VALUE = 270;
    private final int SPEED_STARTING_VALUE = 5;
    ...
    private final int RESISTANCE_STARTING_VALUE = 9;
    private final int ARMOR_STARTING_VALUE = 9;
    ...
    private final int VIEW_RANGE = 3;

...
public class HumanPlayer extends BaseTroop {
    ...
    private final int MERCHANT_STARTING_VALUE = 1;
    private final int LIFE_REGENERATION_STARTING_VALUE = 3;
    private final float LIFE_REGENERATION_TIMER_STARTING_VALUE = 30;
    private final int ARMOR_STARTING_VALUE = 6;
    private final int MANA_STARTING_VALUE = 20;
    private final int MANA_REGENERATION_STARTING_VALUE = 1;
    private final float MANA_REGENERATION_TIMER_STARTING_VALUE = 30;

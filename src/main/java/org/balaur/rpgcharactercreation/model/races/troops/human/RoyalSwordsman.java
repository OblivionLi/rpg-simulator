...
public class RoyalSwordsman extends BaseTroop {
    private final int COMBAT_STARTING_VALUE = 23;
    private final int HEALTH_STARTING_VALUE = 300;
    private final int SPEED_STARTING_VALUE = 13;
    ...
    private final int RESISTANCE_STARTING_VALUE = 15;
    private final int ARMOR_STARTING_VALUE = 15;
    private final int LIFE_REGENERATION_STARTING_VALUE = 8;
    ...
    private final int VIEW_RANGE = 10;

    public RoyalSwordsman() {

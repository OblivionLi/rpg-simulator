...
public class LordCavalry extends BaseTroop {
    private final int COMBAT_STARTING_VALUE = 19;
    private final int HEALTH_STARTING_VALUE = 230;
    ...
    private final int ARMOR_STARTING_VALUE = 12;

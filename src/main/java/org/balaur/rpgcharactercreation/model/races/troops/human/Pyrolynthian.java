...
public class Pyrolynthian extends BaseTroop {
    private final int COMBAT_STARTING_VALUE = 95;
    private final int HEALTH_STARTING_VALUE = 950;
    ...
    private final int RESISTANCE_STARTING_VALUE = 36;
    private final int ARMOR_STARTING_VALUE = 21;

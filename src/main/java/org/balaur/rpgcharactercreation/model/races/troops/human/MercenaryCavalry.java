...
public class MercenaryCavalry extends BaseTroop {
    private final int COMBAT_STARTING_VALUE = 16;
    private final int HEALTH_STARTING_VALUE = 180;
    private final int SPEED_STARTING_VALUE = 14;

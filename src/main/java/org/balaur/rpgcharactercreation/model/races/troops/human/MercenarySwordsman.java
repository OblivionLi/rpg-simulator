...
public class MercenarySwordsman extends BaseTroop {
    private final int COMBAT_STARTING_VALUE = 10;
    private final int HEALTH_STARTING_VALUE = 70;
    private final int SPEED_STARTING_VALUE = 11;
    ...
    private final int ARMOR_STARTING_VALUE = 2;
